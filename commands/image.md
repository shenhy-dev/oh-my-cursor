...
1. **Read** the **cursor-image-generation** skill and follow its workflow: **expand a rough user brief into a full prompt** before calling **GenerateImage** (layered prompts, iteration).
